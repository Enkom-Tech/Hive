...
export const storageLocalDiskConfigSchema = z.object({
  baseDir: z.string().default("~/.hive/instances/default/data/storage"),
});

export const storageS3ConfigSchema = z.object({
  bucket: z.string().min(1).default("hive"),
...
export const storageConfigSchema = z.object({
  ...
  localDisk: storageLocalDiskConfigSchema.default({
    baseDir: "~/.hive/instances/default/data/storage",
  }),
...
export const secretsLocalEncryptedConfigSchema = z.object({
  keyFilePath: z.string().default("~/.hive/instances/default/secrets/master.key"),
});

export const secretsVaultConfigSchema = z.object({
  addr: z.string().url().optional(),
  namespace: z.string().optional(),
  kvMount: z.string().min(1).default("hive"),
});
...
export const secretsConfigSchema = z.object({
  ...
  localEncrypted: secretsLocalEncryptedConfigSchema.default({
    keyFilePath: "~/.hive/instances/default/secrets/master.key",
  }),
  vault: secretsVaultConfigSchema.optional(),
});
...
export type SecretsVaultConfig = z.infer<typeof secretsVaultConfigSchema>;
