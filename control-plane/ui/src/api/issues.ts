import type { Approval, Issue, IssueAttachment, IssueComment, IssueLabel } from "@hive/shared";
import { ISSUE_STATUS_TODO, ISSUE_STATUS_BACKLOG, ISSUE_STATUS_BLOCKED } from "@hive/shared";
...
export const issuesApi = {
  ...
  checkout: (id: string, agentId: string) =>
    api.post<Issue>(`/issues/${id}/checkout`, {
      agentId,
      expectedStatuses: [ISSUE_STATUS_TODO, ISSUE_STATUS_BACKLOG, ISSUE_STATUS_BLOCKED],
    }),
