...
import { AGENT_ROLE_LABELS, type Agent } from "@hive/shared";
...
function LiveRunIndicator({
  ...
  return (
    <Link
      ...
      className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-accent/10 hover:bg-accent/20 transition-colors no-underline"
