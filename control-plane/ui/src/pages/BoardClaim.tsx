...
import { isLikelyApiUnreachableError } from "@/lib/api-unreachable";
...
export function BoardClaimPage() {
  ...
  if (statusQuery.error && isLikelyApiUnreachableError(statusQuery.error)) {
    return <ApiUnreachableNotice error={statusQuery.error} />;
  }
