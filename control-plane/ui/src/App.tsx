...
function CloudAccessGate() {
  ...
  if (healthQuery.error) {
    return <ApiUnreachableNotice error={healthQuery.error} />;
  }
...
function OnboardingRoutePage() {
  ...
  const title = matchedCompany
    ? `Onboarding for ${matchedCompany.name}`
    : companies.length > 0
      ? "Create another company"
      : "Create your first company";
  const description = matchedCompany
    ? "Connect a worker, review your COO agent, or finish setup from the guided flow."
    : companies.length > 0
      ? "Run onboarding again to create another company with mission, worker enrollment, and COO agent."
      : "Create your company, connect a worker, and set up your COO orchestration agent.";
    ...
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        ...
        <div className="mt-4">
          ...
          >
            {matchedCompany ? "Open onboarding" : "Start onboarding"}
          </Button>
        </div>
      </div>
    </div>
    ...
    <>
      <Routes>
        ...
        <Route element={<CloudAccessGate />}>
          ...
          <Route path="instance/status" element={<Layout />}>
            <Route index element={<InstanceStatus />} />
          </Route>
          ...
          <Route path="workers" element={<UnprefixedBoardRedirect />} />
