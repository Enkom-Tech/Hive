...
export function LiveRunWidget({ issueId, companyId }: LiveRunWidgetProps) {
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-accent/25 bg-background/80 shadow-[0_18px_50px_rgba(var(--accent-rgb),0.08)]">
      <div className="border-b border-border/60 bg-accent/5 px-4 py-3">
            ...
            <section key={run.id} className="px-4 py-4">
              <div className="mb-3 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div className="min-w-0">
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
                    <Link
                      ...
                      className="inline-flex items-center rounded-full border border-border/70 bg-background/70 px-2 py-1 font-mono hover:border-accent/30 hover:text-foreground"
                    >
                      {run.id.slice(0, 8)}
                    </Link>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Link
                    to={`/agents/${run.agentId}/runs/${run.id}`}
                    className="inline-flex items-center gap-1 rounded-full border border-border/70 bg-background/70 px-2.5 py-1 text-[11px] font-medium text-accent transition-colors hover:border-accent/30 hover:text-accent"
                  >
                    Open run
