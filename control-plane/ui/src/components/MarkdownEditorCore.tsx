...
import { buildProjectMentionHref, parseProjectMentionHref } from "@hive/shared";
...
export const MarkdownEditorCore = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditorCore({
  value,
  onChange,
  placeholder,
  className,
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("hive-project-mention-chip");
      ...
      link.classList.add("hive-project-mention-chip");
  ...
  return (
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("hive-mdxeditor", !bordered && "hive-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "hive-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
        plugins={plugins}
      />
