...
import type { HeartbeatRun, HeartbeatRunEvent, LiveEvent } from "@hive/shared";
...
} from "./agent-detail-scroll.js";
import { formatEnvForDisplay } from "./agent-detail-env-display.js";
