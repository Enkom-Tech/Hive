...
import { HiveLogoIcon } from "./HiveLogoIcon";

const ORDER_STORAGE_KEY = "hive.companyOrder";
              ...
              {hasLiveAgents && (
                <span className="pointer-events-none absolute -right-0.5 -top-0.5 z-10">
                  <span className="relative flex h-2.5 w-2.5">
                    <span className="absolute inline-flex h-full w-full animate-pulse rounded-full bg-accent opacity-80" />
...
export function CompanyRail() {
  ...
  return (
    <div className="flex flex-col items-center w-[72px] shrink-0 h-full bg-background border-r border-border">
      {/* Hive logo - aligned with top sections (implied line, no visible border) */}
