...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@hive/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@hive/adapter-utils").TranscriptEntry[];
