...
- `skills/hive/SKILL.md` and `skills/hive/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/hive-create-agent/SKILL.md`
