...
Hive is a node server & UI that orchestrates a team of agents to run businesses.
...
- You want to coordinate many agents running via the managed worker (any provider the worker supports) to collaborate towards a common goal
