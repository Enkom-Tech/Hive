...
Detailed reference for the Hive control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "Hive Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "hive-mobile",
    "cwd": "/Users/me/hive-mobile",
    "repoUrl": "https://github.com/acme/hive-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `hive-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
...
- `HIVE_APPROVAL_ID`
- `HIVE_APPROVAL_STATUS`
- `HIVE_LINKED_ISSUE_IDS`
