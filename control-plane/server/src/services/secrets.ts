...
import { companySecrets, companySecretVersions } from "@hive/db";
import type { AgentEnvConfig, EnvBinding, SecretProvider } from "@hive/shared";
import { envBindingSchema } from "@hive/shared";
