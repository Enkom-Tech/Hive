...
import { companies, companyMemberships, instanceUserRoles } from "@hive/db";
import type { DeploymentMode } from "@hive/shared";

/** Synthetic user id used only in local_trusted mode; must not block first real admin in authenticated mode. */
