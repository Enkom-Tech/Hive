 ...
 */
export function wantsAgentPayloadToon(req: Request): boolean {
  if (envWantsToon()) {
    return true;
  }
...
export function buildWorkerApiSuccessResponse(req: Request, result: unknown): { ok: true; result: unknown } | { ok: true; format: "toon"; result: string } {
