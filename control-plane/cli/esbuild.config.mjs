/**
 * esbuild configuration for building the Hive CLI for npm.
 *
 * Bundles all workspace packages (@hive/*) into a single file.
...
// Adapter packages are optional; only existing paths are used for dependency scanning.
...
const workspacePaths = allWorkspacePaths.filter((p) =>
  existsSync(resolve(repoRoot, p, "package.json"))
);

// Workspace packages that should NOT be bundled — they'll be published
// to npm and resolved at runtime (e.g. @hive/server uses dynamic import).
