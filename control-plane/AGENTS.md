...
`doc/MANAGED-WORKER-ARCHITECTURE.md` describes the target worker/agent architecture.
`doc/DRONE-SPEC.md` is the implementation spec for the worker/drone process. Worker–control plane communication is **WebSocket-only** (drone connects to control plane).
